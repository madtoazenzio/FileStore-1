...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7528683061:AAF8fUMKxAFu3UlmfLQum0be0y3NgQyLA0c")
#Your API ID from my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "7236453"))
#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "33010a70e94f80e55145980072cce969")
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002447703798"))
# NAMA OWNER
...
START_PIC = os.environ.get("START_PIC", "https://envs.sh/b5p.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://envs.sh/b5p.jpg")

HELP_TXT = "<b>ᴛʜɪs ɪs ᴀɴ ғɪʟᴇ ᴛᴏ ʟɪɴᴋ ʙᴏᴛ ᴡᴏʀᴋ ғᴏʀ @zooistore\n\n❏ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅs\n├/start : sᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ\n├/about : ᴏᴜʀ Iɴғᴏʀᴍᴀᴛɪᴏɴ\n└/help : ʜᴇʟᴘ ʀᴇʟᴀᴛᴇᴅ ʙᴏᴛ\n\n sɪᴍᴘʟʏ ᴄʟɪᴄᴋ ᴏɴ ʟɪɴᴋ ᴀɴᴅ sᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ ᴊᴏɪɴ ʙᴏᴛʜ ᴄʜᴀɴɴᴇʟs ᴀɴᴅ ᴛʀʏ ᴀɢᴀɪɴ ᴛʜᴀᴛs ɪᴛ.....!\n\n ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ <a href=https://t.me/cosmic_freak>sᴜʙᴀʀᴜ</a></b>"
